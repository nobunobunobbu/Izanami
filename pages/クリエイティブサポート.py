...
with tab3:
    ...
    model2 = st.selectbox('GPTモデルの選択', ['gpt-3.5-turbo','gpt-3.5-turbo-16k',  'gpt-4-0613'], help="gpt-3.5-turbo-16k :より長文のプロンプトを受け付けます。gpt-4:未対応となります。" , key="model_select")
...
with tab2:
    ...
    model = st.selectbox('GPTモデルの選択', ['gpt-3.5-turbo','gpt-3.5-turbo-16k',  'gpt-4-0613'], help="gpt-3.5-turbo-16k :より長文のプロンプトを受け付けます。gpt-4:未対応となります。" , key="model_select2")
